...
CFLAGS	= -m32 -O3 -Wall -Wextra -std=c11 -Wno-format -Wno-parentheses
CFLAGS	= -g -Wall -Wextra -std=c11 -Wno-parentheses -fprofile-arcs -ftest-coverage
CFLAGS = -g -std=c11 -O3#-fno-omit-frame-pointer
OUT	= fm
NOTE	= note
FILE	= fast
